...
\def \figIcuCardio {
    ...
    \vspace{12px}
    (a) Conditional distributions of network output given the diagnosis is positive or negative for cardiogenic shock. (b) Effective sensitivity of the network for detecting a cardiogenic shock.  As an example, assume only 20\% of the patients can be tested with an expensive but perfect test. Using the net to flag the 20 percentile patients at highest risk for further testing would detect 66\% of the cases.
...
\def \figIcuSystolic {
    ...
    \vspace{12px}
    (a) Conditional distributions of network output given the diagnosis is positive or negative for systolic heart failure. (b) Effective sensitivity of the network for detecting systolic heart failure.  As an example, assume only 20\% of the patients can be tested with an expensive but perfect test. Using the net to flag the 20 percentile patients at highest risk for further testing would detect 56\% of the cases.
...
\def \figIcuCerebral {
    ...
    \vspace{12px}
    (a) Conditional distributions of network output given the diagnosis is positive or negative for cerebral aneurysm. (b) Effective sensitivity of the network for detecting a cerebral aneurysm.  As an example, assume only 20\% of the patients can be tested with an expensive but perfect test. Using the net to flag the 20 percentile patients at highest risk for further testing would detect 63\% of the cases.
...
\def \figIcuMyocard {
    ...
    \vspace{12px}
    (a) Conditional distributions of network output given the diagnosis is positive or negative for myocardial infarction. (b) Effective sensitivity of the network for detecting a myocardial infarction.  As an example, assume only 20\% of the patients can be tested with an expensive but perfect test. Using the net to flag the 20 percentile patients at highest risk for further testing would detect 57\% of the cases.
